...
让 Agent 按照 [安装 Skill](https://github.com/OpenSenseNova/SenseNova-Skills-ProactiveAgent/blob/main/skills/proactive-memory/SKILL.md) 帮你安装服务并接入助手，也可以自行参考 [安装指南](https://github.com/OpenSenseNova/SenseNova-Skills-ProactiveAgent/blob/main/skills/proactive-memory/references/install/overview.md)。
