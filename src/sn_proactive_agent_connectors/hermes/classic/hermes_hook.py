#!/usr/bin/env python3
"""Map Hermes shell-hook payloads to Proactive Agent V1 HTTP events."""
...
def main() -> None:
    ...
    try:
        ...
        print(f"sn-proactive-agent hook: {type(exc).__name__}: {exc}", file=sys.stderr)
    print("{}")
